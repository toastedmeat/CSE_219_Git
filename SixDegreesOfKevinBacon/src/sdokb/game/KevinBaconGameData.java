...
/**
 * KevinBaconGameData stores the data necessary for a single game, including the
...
public class KevinBaconGameData {
    ...
    public Iterator<Connection> gamePathIterator() {
        return gamePath.iterator();
    }
    ...
    public void setLastConnection(Connection connect) {
        lastNode = connect;
    }

    public void setStartingActor(Actor actor) {
        startingActor = actor;
    }

    /**
     * Accessor method for testing to see if Kevin Bacon has been found this
     * game or not.
     *
    ...
    /**
     * Accessor method for testing to see if the game is waiting for the user to
     * enter a film or not.
     *
     * @return true if the game is waiting for the user to pick a film, false
     * otherwise (an actor).
     */
    public void setIsWaitingForFilm(Boolean x) {
        waitingForFilm = x;
    }
    ...
    /**
     * Tests to see if the guessId argument has been made. If it has, true is
    ...
    /**
     * This method builds and returns a list of all the ids referenced by the
     * guessId that have not already been used in this game.
     */
    ...
    /**
     * This method constructs and returns a textual description of the time it
